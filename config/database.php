    ...
    */
    ...
    'connections' => [
        ...
        'production' => [
            'driver' => 'mysql',
            'url' => env('PROD_DB_URL'),
            'host' => env('PROD_DB_HOST', '85.198.119.37'),
            'port' => env('PROD_DB_PORT', '3306'),
            'database' => env('PROD_DB_DATABASE', 'new_woodstre'),
            'username' => env('PROD_DB_USERNAME', 'new_woodstre'),
            'password' => env('PROD_DB_PASSWORD', 'yHQhKKgWh8QbRcXk'),
